...
function createPayButton(title,payload){
  return{
...
function listMessage(top_element_style,elements, buttons) {
  return {
    attachment: {
      type: "template",
      payload: {
...
function genericMessage(elements, quick_replies) {
  return {
    "quick_replies":quick_replies,
    attachment: {
      type: "template",
...
exports.createPayButton=createPayButton;